...
// End-to-end integration tests: .NET 10 PipeChannel -> Access-ACE-Agent.exe -> AccessComService -> Access COM.
...
public class WorkerPipeIntegrationTests
{
    ...
    private static string FindWorkerExe()
    {
        ...
        if (found == null)
            Assert.Inconclusive("Access-ACE-Agent.exe not found. Build Access_ACE_Agent first.");
        return found!;
    }
